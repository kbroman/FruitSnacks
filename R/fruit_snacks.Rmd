...
can't much distinguish among them.) So there was an average of `r
round(sum(fs)/nrow(fs), 1)` fruit snacks per package, with a range of
...
We can see immediately that the different colors clearly differ in
frequency.  But the distributions look plausibly random. If colors
